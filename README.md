...
- **프로필 관리** — 여러 직번/바코드를 저장하고 탭으로 전환
- **오프라인 지원** — 서비스 워커 기반, 네트워크 없이도 바코드 생성 가능
- **다크/라이트 테마** — 시스템 설정 자동 연동 또는 수동 전환
- **이미지 저장 & 공유** — 생성된 바코드를 PNG로 다운로드하거나 공유
- **즐겨찾기 & 최근 기록** — 자주 쓰는 바코드 즐겨찾기 등록
- **화면 꺼짐 방지** — Wake Lock API로 바코드 스캔 중 화면 유지
...
NFC 태그, 시간, 위치 등의 자동화 트리거와 조합하면 더 편리하게 사용할 수 있습니다.
